...
<head>
    ...
    <meta name="description" content="Website Soundify_ Form Page">
...
<br>
  ...
  <form action="3.landing.php" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="telp" class="form-control" placeholder="Masukkan nomor" required>
    ...
    <div>
      ...
      <input type="radio" name="jenisKelamin" value="Laki-laki"> Laki-Laki    </div>
    </div>
    ...
    <div class="mb-4">
      ...
      <select name="kelas" class="form-select" required>
        <option value="Minor(250K)">Minor(250K)</option>
        <option value="Mayor(750K)">Mayor(750K)</option>
        <option value="Diva(1000K)">Diva(1000K)</option>
      </select>
    </div>
...
<div>
  <label class="form-label">Pernah Langganan</label> <br>
      <input type="radio" name="pernahLangganan" value="Ya" required> Ya&nbsp;&nbsp;
      <input type="radio" name="pernahLangganan" value="Tidak"> Tidak   
</div>

<br>
    <!-- <div class="text-center"> -->
      <div class="Text-center d-flex justify-content-between mt-4">
      <button type="submit" class="btn-detail">Daftar</button>
    </div>  
