                ...
                <form action="3.landing.php" method="POST">
                        ...
                        <div class="mb-3">
                          <label class="form-label">Tanggal Lahir</label>
                            <input type="text" name="tanggalLahir" class="form-control" placeholder="Masukkan Tanggal Lahir anda" required>
                        </div>

                        <div class="mb-3">
                          <label class="form-label">Domisili</label>
                            <input type="text" name="domisili" class="form-control" placeholder="Masukkan domisili anda" required>
                        </div>

                        <div class="mb-3">
                          <label class="form-label">Lomba</label>
                            <input type="text" name="lomba" class="form-control" placeholder="Masukkan jenis lomba" required>
                        </div>
<div class="mb-3">
...
<br>
                     ...
                     <div class="mb-3">
                         <h2> <label class="form-label">Total</label></h2>
                            <input type="text" name="total" class="form-control" required>
                        </div>

                        <p>Voucher Pokemon Berhasil:)</p>

                     <br>
                    <center> <a href="3.landing" class="btn-detail">Daftar Sekarang</a>
